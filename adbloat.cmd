...
echo Optimizing ...
    ...
    adb shell pm trim-caches 999999M
    adb shell rm -rfd /cache/*.apk
    adb shell rm -rfd /cache/*.tmp
    adb shell rm -rfd /cache/*.log
    ...
    adb shell rm -rfd /data/system/usagestats/*
    adb shell rm -rfd /data/anr/*
    adb shell rm -rfd /data/crashdata/*
    adb shell rm -rfd /data/dalvik-cache/*
    adb shell rm -rfd /data/data/*/cache/*
    adb shell rm -rfd /data/cache/*.*
    adb shell rm -rfd /data/resource-cache/*
